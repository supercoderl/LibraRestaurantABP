using LibraRestaurant.IdentityService.BackgroundJobs.Users;
...
namespace LibraRestaurant.IdentityService.Identity
{
    ...
    public class LibraRestaurantIdentityUserAppService : IdentityUserAppService
    {
        private readonly IIdentityUserRepository _userRepository;
        private readonly IBackgroundJobManager _backgroundJobManager;
        private readonly IIdentityRoleRepository _roleRepository;

        public LibraRestaurantIdentityUserAppService(
