...
namespace LibraRestaurant.DbMigrator
{
    public class KeycloakDataSeeder : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateAdministrationClientAsync()
        {
            var administrationClient =
                (await _keycloakClient.GetClientsAsync(_keycloakOptions.RealmName,
                    clientId: "LibraRestaurant_AdministrationService"))
                .FirstOrDefault();
                ...
                administrationClient.Attributes = new Dictionary<string, object>()
            {
                ...
                await AddOptionalClientScopesAsync(
                    "LibraRestaurant_AdministrationService",
                    new List<string>
                    {
                    "IdentityService"
                    }
                ...
                var insertedClient =
                    (await _keycloakClient.GetClientsAsync(_keycloakOptions.RealmName, clientId: "LibraRestaurant_AdministrationService"))
                    .First();
        ...
        {
            var cmsKitClient =
                (await _keycloakClient.GetClientsAsync(_keycloakOptions.RealmName, clientId: "LibraRestaurant_CmskitService"))
                .FirstOrDefault();
            ...
            if (cmsKitClient == null)
            {
                ...
                {
                    ClientId = "LibraRestaurant_CmskitService",
