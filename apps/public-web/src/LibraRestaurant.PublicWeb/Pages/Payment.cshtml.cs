...
namespace LibraRestaurant.PublicWeb.Pages
{
    ...
    public class PaymentModel : AbpPageModel
    {
        ...
        private readonly LibraRestaurantPublicWebPaymentOptions _publicWebPaymentOptions;
        ...
        public PaymentModel(
            ...
            IOptions<LibraRestaurantPublicWebPaymentOptions> publicWebPaymentOptions)
        {
        ...
        public async Task<IActionResult> OnPostAsync(PaymentPageViewModel model)
        {
            ...
            var paymentRequest = await _paymentRequestAppService.CreateAsync(new PaymentRequestCreationDto
            {
                ...
                Currency = LibraRestaurantPaymentConsts.Currency,
